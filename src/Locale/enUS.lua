...
_G["BINDING_NAME_LUCKYWARDROBE_TOGGLE_SET_LIST"] = "Sets You Can Finish Here"
...
L["Shift-right-click an appearance for its Wowhead address, ready to copy into your browser. Turn this off if you use shift-right-click for something else."] = true
L["Left-click: Open appearances"] = true
L["Shift-click: Sets you can finish here"] = true
L["Right-click: Open settings"] = true
L["Drag: Move button"] = true
L["Transmog Window"] = true
L["Keep Active Transmog Tab"] = true
L["Track Sets on Shift-Click"] = true
L["Shift-click a set to start tracking every appearance you are still missing from it, the way shift-clicking an item on the Items tab tracks that one. Shift-clicking a single piece in the set details tracks just that piece."] = true
L["Now tracking %d appearance from %s."] = true
L["Now tracking %d appearances from %s."] = true
L["Nothing new to track from %s."] = true
L["%d could not be tracked."] = true
L["Now tracking %s."] = true
L["%s is already collected or being tracked."] = true
...
L["Show Situation Tooltips"] = true
L["Shows an outfit's full situation list, with the values selected in each category, in a tooltip when you hover it."] = true
L["Tooltips"] = true
L["Show Appearance Status"] = true
L["Adds a line to item tooltips showing whether you have already collected that item's appearance."] = true
L["Show Set Membership"] = true
...
L["How incomplete a set can be and still count as one you are close to finishing. At 3, a set you are missing four or more pieces of is left out of the instance list and never alerts."] = true
L["Include the Current Tier"] = true
L["Sets from the tier you are raiding now are left out, on the grounds that you will finish those by turning up. Turn this on to hear about them anyway. Older sets you have gone back for are never affected."] = true
L["In Dungeons and Raids"] = true
L["Open the List Automatically"] = true
L["Opens a list when you enter a dungeon or raid of the sets you are close to completing whose missing pieces drop there. Type /bw sets, use a keybinding, or shift-click the minimap button to open it any time, whether this is on or off."] = true
L["Move Aside After"] = true
L["How long the list holds the middle of the screen before it shrinks into the corner. At 0 it opens in the corner and never takes the middle."] = true
L["Reset Window Position"] = true
L["Puts the list back in the top-left corner, for a drag that left it somewhere you cannot reach."] = true
L["Finish a Set Here"] = true
L["Collected: %d of %d"] = true
L["Drops on %s"] = true
L["Still missing %d pieces from elsewhere"] = true
L["Click: Show this set in your appearances"] = true
L["Nothing here finishes a set."] = true
L["and %d more"] = true
L["Drops from"] = true
L["Comes from this instance"] = true
L["Mark Pieces You Could Catalyse"] = true
L["Stamps a catalyst mark on a piece you are missing when you are already carrying something the catalyst would turn into it. Hover the piece to see which item."] = true
L["The catalyst would make this from"] = true
L["%d you could catalyse from what you are carrying"] = true
L["Expand the window"] = true
L["Shrink the window"] = true
L["When You Loot"] = true
L["Alert on Set Pieces"] = true
L["Speaks up when you loot a piece of a set you are close to finishing, wherever you are."] = true
L["Alert on Catalyst Upgrades"] = true
L["Speaks up, more quietly, when you loot something the catalyst could turn into an appearance you are missing."] = true
L["Alert With"] = true
L["How an alert reaches you. A long clear puts a lot of lines in chat, and the sound alone carries just as well."] = true
L["Sound"] = true
L["Chat message"] = true
L["%s finishes %s"] = true
L["%s is a piece of %s, %d still missing"] = true
L["%s can be catalysed into an appearance you are missing"] = true
L["You are not in a dungeon or raid."] = true

L["Reading Outfit Situations"] = true
L["Each outfit is being opened to read its situation values. Please wait, using the wardrobe now will interrupt the scan."] = true
L["%d of %d outfits"] = true
L["Dev Mode"] = true
L["Version Info"] = true
