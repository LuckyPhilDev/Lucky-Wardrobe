...
L["Sound"] = true
L["Chat message"] = true
L["Highlight Lasts"] = true
L["How long the piece that just dropped keeps glowing on the instance list, when the list is open."] = true
L["Needs Transmog Upgrade Master installed. The game gives no way to work out what the catalyst produces."] = true
L["%s finishes %s"] = true
